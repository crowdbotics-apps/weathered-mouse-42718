"""
Django settings for weathered_mouse_42718 project.
...
ROOT_URLCONF = 'weathered_mouse_42718.urls'
...
WSGI_APPLICATION = 'weathered_mouse_42718.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "weathered_mouse_42718 API",
    "DESCRIPTION": "API documentation for weathered_mouse_42718 App",
    "VERSION": "v1",
}
